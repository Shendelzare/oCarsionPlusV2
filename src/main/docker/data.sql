...
CREATE SEQUENCE ocarsionplus_marca_id_seq AS INT INCREMENT BY 1;
CREATE SEQUENCE ocarsionplus_coche_id_seq AS INT INCREMENT BY 1;
CREATE SEQUENCE ocarsionplus_precio_id_seq AS INT INCREMENT BY 1;
CREATE SEQUENCE ocarsionplus_extra_id_seq AS INT INCREMENT BY 1;
CREATE SEQUENCE ocarsionplus_usuario_id_seq AS INT INCREMENT BY 1;
